...
## Self-Improve Guardrails (AIBot)

When running autonomous maintenance or self-improvement tasks:

- Scope: only modify files under /home/felixlee/Desktop/aibot.
- Never modify secrets: .env, .secrets/, credentials/, /home/felixlee/.openclaw/.env.
